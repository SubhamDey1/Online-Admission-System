...
?>
      <form id="admin" action="admin.php" method="post">
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/rs.png" width="100%" style="box-shadow: 0px 5px 5px #999999; "></img>
                  </div>
                 </div>    
             </div>
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <tr>
                 <td style="width:3%;"><img src="./images/Logo-home.gif" width="50%"> </td>
                 <td style="width:8%;"><center><font style="font-family:Arial Black; font-size:20px;">
                    RS COLLEGE OF ENGINEERING, PURBA BURDWAN - 713102, BURDWAN</font></center>
                
                <center><font style="font-family:Verdana; font-size:18px;">
                    Phone : 9002258897 / 9564215456
                    </font></center>
