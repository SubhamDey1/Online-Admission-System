...
<html>
    ...
    <body  style="background-image:url('./images/Parkway-backgroun.jpg');" >
        <form id="index" action="index.php" method="post">
            
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/rs.png" width="100%" style="box-shadow: 1px 5px 14px #999999; "></img>
                  </div>
                 </div>    
                ...
                <div  id="divtop">
                        ...
                        <br> <br> <br> <br>
                            <div id="dmain"  > 
                               <center><h1><font color='blue', style="box-shadow: 1px 2px 3px">LOGIN PAGE</font></h1> <width="120px" height="100px" ></center>
                                <br>
